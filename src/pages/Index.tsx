...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted">
      <iframe
        className="hidden"
        src={`https://www.youtube.com/embed/2e1cbsBygRA?autoplay=${isMusicPlaying ? '1' : '0'}&loop=1&playlist=2e1cbsBygRA&controls=0`}
        allow="autoplay"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-foreground max-w-3xl mx-auto leading-relaxed mb-4">
              Приглашаю провести день на термальном комплексе в окружении адыгейских гор. С собой обязательно возьми хорошее настроение и меня 😁
            </p>
